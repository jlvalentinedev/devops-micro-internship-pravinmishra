...
![nodejs](screenshots/nodejsimg.png)
...
![nginx](screenshots/nginxpager.png)
...
![reactapp](screenshots/my-react-app.png)
...
![reactapp](screenshots/Appconfirm.png)
...
![reactapp](screenshots/buildconf.png)
...
![reactapp](screenshots/var-permis.png)
...
![reactapp](screenshots/activeinginx.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![reactapp](screenshots/inginxportconf.png)
...
![reactapp](screenshots/serverip.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![reactapp](screenshots/Reactappwithname.png)
...
(https://www.linkedin.com/posts/jlvalentine80_dmi-cohort-4-live-micro-internship-waiting-share-7485377917905043456-TqBf/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAALB3J0BwtFufEKpichQKK5s_jlChwTdfk8)`

---

#### Screenshot — LinkedIn post showing the deployed application

![reactapp](screenshots/linkedofdeployed.png)
