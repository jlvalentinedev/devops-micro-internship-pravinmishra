...
![github](screenshots/github1.png)

---

#### Screenshot 2 — Output of `ls -a` showing the `.git` folder

![github](screenshots/github2.png)
...
The .git folder is the heart of every Git repository. It’s the hidden control room where Git stores everything it needs to track your project’s history, branches, remotes, and changes.
...
![github](screenshots/github3.png)
...
![github](screenshots/github4.png)
